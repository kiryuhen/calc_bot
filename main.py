...
def getMessage(messsage):
    global value, old_value
    if value == '':
        bot.send_message(messsage.from_user.id, 'Привет', reply_markup=keyboard)
    else:
        bot.send_message(messsage.from_user.id, value, reply_markup=keyboard)
